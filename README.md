...
| [**Bill Bench**](https://github.com/NickkkLian/bill-categoriser) | Clean, categorise and reconcile a year of bills in the browser — every row stays traceable. | Python stdlib, seeded synthetic data, GitHub Actions on Windows/macOS/Linux |
| [**Callback Desk**](https://github.com/NickkkLian/missed-call-booking) | Turn missed calls into bookings — staff approve every message and every calendar write. | n8n JSON, Node stdlib simulator, no external services |
| [**CallDelta**](https://github.com/NickkkLian/Earnings-Call-Sentiment-Analyser) | Call tone vs. analyst pushback — not a trading signal. | Python, LLM-scored transcripts, residual-return target |
...
| [**Vacancy Signal**](https://github.com/NickkkLian/Ghost-Job-Detection-And-Trading-Signal) | Ghost job postings as an equity signal — the course report's figures, not recomputed here: the data is licensed. (UBC Sauder, team project) | Python, scikit-learn, XGBoost |
| [**Letterkeep**](https://github.com/NickkkLian/Prof-Reference-System) | Students check whether they qualify for a reference letter before they ask — the roster, the grades and the files never leave the professor's own machine. | Flask, SQLite |
